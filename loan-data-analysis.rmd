...
ggplot(data = sub_data, aes(sub_data$BorrowerAPR)) + 
  geom_histogram(col = "blue", bins = 50, alpha = 0.8, aes(fill = ..count..)) +   labs(title = "Histogram - BorrowerAPR", x = "Values", y = "Frequency") 
...
ggplot(data = sub_data, aes(sub_data$BorrowerRate)) + 
  geom_histogram(col = "blue", bins = 50, alpha = 0.8, aes(fill = ..count..)) +   labs(title = "Histogram - BorrowerRate", x = "Values", y = "Frequency") 
